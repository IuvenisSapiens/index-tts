...
class IndexTTS2:
    def __init__(
        ...
        self.extract_features = SeamlessM4TFeatureExtractor.from_pretrained("./checkpoints/hf_cache/facebook/w2v-bert-2.0")
        ...
        semantic_code_ckpt = "./checkpoints/hf_cache/amphion/MaskGCT/semantic_codec/model.safetensors"
        ...
        # load campplus_model
        campplus_ckpt_path = "./checkpoints/hf_cache/funasr/campplus/campplus_cn_common.bin"
